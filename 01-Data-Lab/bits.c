...
int palindrome(int x) {
  ...
  // reverse 2 by 2
  result = ((x & mask_1) << 1) | ((x >> 1) & mask_1);
  // reverse 4 by 4
  result = ((result & mask_2) << 2) | ((result >> 2) & mask_2);
  // reverse 8 by 8
  result = ((result & mask_3) << 4) | ((result >> 4) & mask_3);
  // reverse 16 by 16
  result = ((result & mask_4) << 8) | ((result >> 8) & mask_4);
  // reverse 32 by 32
  result = ((result & mask_5) << 16) | ((result >> 16) & mask_5);
  return !(x ^ result);
}
/* 
 * negate - return -x 
